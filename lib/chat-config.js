...
- Bredd: 0 kr i startavgift, 1 990 kr/mån. Allt i Bas plus obegränsat antal sidor, skräddarsydd design, sökord för orterna runt om och SEO-rapport varje månad. De flesta landar här.
...
- WordPress-migrering: 0 kr när kunden tecknar drift i 12 månader.
- SEO-audit som engångstjänst: 4 900 kr.
- Ta över befintlig sajt: 1 190 kr/mån, 0 kr start.
Kunden äger domän och innehåll från dag ett och får sajten exporterad utan kostnad vid uppsägning. Bindningen är 12 månader på alla paket, därefter månadsvis. Efter 12 månader räcker ett mejl för att avsluta till nästa månadsskifte.

RIKTIGA KUNDCASE:
- Niklassons Flytt, 32 offertförfrågningar på 30 dagar, 38 sidor över Skåne
- Arkipel Entreprenad, 61 sidor åt ett byggföretag i Norrköping
- Premie Bygg, 47 sidor, formulärkedjan verifierad
- Norrlands Gräv & Transport, 69 sidor, canonical-fel mot Google fixat
- Linguista och EdShare, AcadeMedia
- Förskolan Harpan, Hemsida och grafisk profil
- Kvota.se, AI-driven SaaS för offertgenerering

KONTAKT:
- Boka genomgång: stoltmarketing.se/boka (15–20 min, kostnadsfritt)
- E-post: joel@stoltmarketing.se
- Telefon: 076-686 74 06
