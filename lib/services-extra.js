...
export const EXTRA_SERVICES = {
  ...
  "facebook-annonsering": {
    ...
    faqs: [
      { q: "Vad kostar det att annonsera på Facebook?", a: "Två delar: annonsbudgeten som går till Meta och arvodet för att sköta kampanjerna. En rimlig startbudget för ett lokalt företag är 3 000 till 6 000 kr i månaden till Meta. Hanteringen ingår i Tillväxt, 2 490 kr/mån, tillsammans med Google Ads och SEO." },
  ...
  "ai-synlighet": {
    ...
    faqs: [
      ...
      { q: "Vad kostar AI-synlighet?", a: "Ingår i Tillväxt, 2 490 kr/mån, som en del av SEO-arbetet. En engångsmätning med rapport över ditt AI-nuläge kostar 4 900 kr och är en bra start om du vill se läget innan du bestämmer dig." },
    ],
    relatedLabel: "SEO",
