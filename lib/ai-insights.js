...
const OUTPUT_SCHEMA = {
  ...
  properties: {
    summary: {
      type: "string",
      description:
        "1 till 2 meningar på svenska som sammanfattar vad som hände denna period. Konkret, inte allmänt.",
    },
    observations: {
      type: "array",
      description: "2 till 4 viktiga mönster i datat, varje 1 mening på svenska.",
      items: { type: "string" },
    },
    recommendations: {
      type: "array",
      ...
      items: {
        ...
        properties: {
          ...
          why: {
            type: "string",
            description:
              "1 till 2 meningar, varför detta är värt att göra, baserat på specifika siffror i datat.",
          },
          how: {
            type: "string",
            description:
              "1 till 3 meningar, konkreta steg eller riktning för att genomföra åtgärden.",
          },
        },
...
- summary: 1 till 2 meningar som sammanfattar vad som hände denna period.
- observations: 2 till 4 viktiga mönster (varje en mening).
