...
export const CITY_PROOF = {
  hassleholm: [
    ...
    },
    {
      ...
      tag: "Skåne · 32 förfrågningar / 30 dgr",
...
export const SERVICES = {
  hemsida: {
    ...
    faqs: [
      { q: "Hur lång tid tar det att bygga en hemsida?", a: "En enklare webbplats tar oftast 1-2 veckor. Större e-handels- och AI-projekt kan ta 1-2 månader. Ett gratis designförslag för din webb får du inom 2 arbetsdagar, och alltid en tydlig tidplan i förslaget." },
