...
export const SITE = {
  ...
  // 46elks-numret för Stolt Marketing (Dev/internal/elks-router): samtal
  // vidarekopplas till mobilen med detta som callerid, sms mejlas.
  // OBS: GBP:n ska visa SAMMA nummer (NAP-konsistens).
  phone: "076-686 74 06",
...
export const PRICING = {
  ...
  ehandel: "1 990 kr/mån",
  tillvaxt: "2 490 kr/mån",
...
export const SERVICES = {
  ...
  seo: {
    ...
    faqs: [
      ...
      { q: "Vad kostar SEO?", a: "En engångs SEO-audit kostar 4 900 kr. Löpande SEO-arbete ingår i Tillväxt, 2 490 kr/mån. Större SEO-projekt prissätts efter scope." },
  ...
  "google-ads": {
    ...
    priceLabel: "2 490 kr/mån + annonsbudget",
