...
// Prismodellen. Ändras den här ska även combos.json, service-extra-content.json
// och chat-config.js uppdateras, de är JSON/prompt och kan inte importera.
export const PRICING = {
  bas: "0 kr start, 1 190 kr/mån",
  basManad: "1 190 kr/mån",
  bredd: "1 990 kr/mån",
  ehandel: "800 kr/mån som tillägg",
  spets: "2 990 kr/mån",
  wpMigrering: "0 kr när du tecknar drift",
  seoAudit: "4 900 kr",
  bindning: "12 månaders bindning, därefter månadsvis",
  // Google Appointment Schedule: klistra in embed-URL:en med ?gv=true.
  // Ex: https://calendar.google.com/calendar/appointments/schedules/XXXX?gv=true
  // Sätt NEXT_PUBLIC_CALENDAR_URL i .env.local (build-tid, OpenNext) och
  // wrangler.preview.jsonc vars. Tom sträng = /boka visar tidsönskemål, ingen påhittad URL.
...
export const CITY_PROOF = {
  hassleholm: [
    ...
    },
    {
      ...
      tag: "Skåne · varje offertförfrågan mäts",
      line: "38 sidor över Skåne, varje offertförfrågan mäts. Helsingborg som bas.",
  ...
  helsingborg: [
    {
      name: "Niklassons Flytt",
      tag: `Helsingborg · ${SNAPSHOT.rows.find((r) => r.slug === "niklassonsflytt")?.offert} förfrågningar / 30 dgr`,
...
export const SERVICES = {
  hemsida: {
    ...
    process: [
      { title: "Adress & förslag", desc: "Du skickar din webbadress eller ditt företagsnamn. Inom två arbetsdagar har du ett klickbart förslag, gratis och utan möte." },
    ...
    faqs: [
      { q: "Hur lång tid tar det att bygga en hemsida?", a: "En ny hemsida är normalt live inom två veckor efter ditt ja. Större e-handels- och AI-projekt kan ta 1-2 månader. Ett gratis designförslag för din webb får du inom 2 arbetsdagar, och alltid en tydlig tidplan i förslaget." },
      ...
      { q: "Kan jag uppdatera hemsidan själv efteråt?", a: "Ja. Du får ett enkelt CMS och en genomgång så att du kan ändra texter och bilder själv. Vill du slippa ingår drift och innehållsändringar redan i månadspriset." },
    ...
    blog: [
      { title: "Vad kostar en hemsida?", href: "/vad-kostar-en-hemsida" },
  ...
  seo: {
    ...
    priceLabel: "Ingår från 1 190 kr/mån",
    ...
    faqs: [
      { q: "Hur lång tid tar det innan SEO ger resultat?", a: "Tekniska förbättringar syns ofta inom veckor. Sökordspositioner tar vanligtvis 2 till 6 månader att förbättra märkbart. Du får månadsrapporter så du ser framstegen." },
      { q: "Vad kostar SEO?", a: "En engångs SEO-audit kostar 4 900 kr. Löpande SEO-arbete ingår i Spets, 2 990 kr/mån. Större SEO-projekt prissätts efter scope." },
  ...
  "google-ads": {
    ...
    priceLabel: "I Spets, 2 990 kr/mån + annonsbudget",
