...
export const SHARES = {
  ...
  ngtab: {
    ...
    defaultRange: "90day",
    // Umami-vyn är på engelska. Förklaringen på rapportsidan översätter, och
    // event-raden måste vara kundens egen: namnet säger inget i sig.
    eventNamn: "lead-offertformular",
    eventBetyder: "någon har fyllt i och skickat offertformuläret",
  },
};
