    ...
    <>
      ...
      <main>
        <div style={{ padding: '60px 20px', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '20px' }}>Hemsida Lund</h1>
          <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#666' }}>
            Professionell webbutveckling för tech-startups och företag i Lund. Modern design, snabb laddning och SEO-optimerad från start.
          </p>
