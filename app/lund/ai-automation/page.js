    ...
    <>
      ...
      <main>
        <div style={{ padding: '60px 20px', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '20px' }}>Ai-automation Lund</h1>
          <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#666' }}>
            Digital tjänst för företag i Lund och Ideon Science Park. Kontakta oss för att läsa mer eller boka en genomgång.
          </p>
