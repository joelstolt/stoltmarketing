          ...
          <div className="relative z-10 max-w-3xl mx-auto px-5 sm:px-8 pt-28 sm:pt-36 pb-16 sm:pb-20">
            ...
            <Reveal delay={0.12}>
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[13px] text-muted">
                <span className="flex items-center gap-1.5 whitespace-nowrap"><Calendar size={13} /> 19 april 2026</span>
                <span className="flex items-center gap-1.5 whitespace-nowrap"><Clock size={13} /> 7 min läsning</span>
              </div>
            </Reveal>
          </div>
        </section>
