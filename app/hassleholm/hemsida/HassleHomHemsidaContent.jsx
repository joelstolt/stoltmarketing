...
const features = [
  {
    ...
    desc: "Professionell design med tydlig kundresa — anpassad för att bygga förtroende hos lokala kunder i Hässleholm.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    desc: "Rätt sidstruktur, meta-data och innehåll så att du syns när någon söker på din bransch i Hässleholm.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    desc: "Jag sitter i Hässleholm. Du får en fast kontaktperson — inte ett callcenter eller en AI-chattbot.",
  },
];

const faqs = [
  {
    q: "Varför välja en lokal webbyrå i Hässleholm?",
    a: "Du får personlig kontakt med den som faktiskt bygger din sajt. Vi kan ses på plats, jag förstår den lokala marknaden och du slipper mellanhänder. Resultatet? Snabbare leverans, bättre kommunikation och en sajt som faktiskt passar ditt företag.",
  },
  {
  ...
  {
    q: "Kan ni hjälpa företag utanför Hässleholm?",
    a: "Absolut. Jag jobbar med företag i hela Skåne och Sverige — Kristianstad, Lund, Malmö och övriga landet. Men det är extra smidigt för företag i Hässleholmsområdet eftersom vi kan ses fysiskt.",
  },
  {
...
export default function HassleHomHemsidaContent() {
  ...
  return (
    <>
      <PageHero
        ...
        badge="Hemsida Hässleholm"
        title="Professionell hemsida för företag i Hässleholm."
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            badge="Lokal partner"
            title="Varför företag i Hässleholm väljer mig."
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            ...
            subtitle="Samma pris oavsett om du sitter i centrala Hässleholm eller Vinslöv."
          />
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8 bg-surface-muted">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            badge="Serviceområde"
            title="Hemsidor för företag i hela nordöstra Skåne."
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-[720px] mx-auto">
          <SectionHeader
            ...
            title="Frågor om hemsidor i Hässleholm."
          />
