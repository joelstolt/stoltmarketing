...
const features = [
  {
    ...
    desc: "Professionell design med tydlig kundresa — anpassad för att bygga förtroende hos lokala kunder i Helsingborg.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    desc: "Rätt sidstruktur, meta-data och innehål så att du syns när någon söker på din bransch i Helsingborg.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    desc: "Jag sitter i Skåne med nära till Helsingborg. Du får en fast kontaktperson — inte ett callcenter.",
  },
];

const faqs = [
  {
    q: "Varför välja en lokal webbyrå i Helsingborg?",
    a: "Du får personlig kontakt med den som faktiskt bygger din sajt. Jag förstår den lokala marknaden i Helsingborg och du slipper mellanhänder.",
  },
  {
    q: "Vad kostar det att bygga en hemsida?",
    a: "En företagssajt börjar från 3 900 kr med fast pris. Behöver du e-handel eller mer avancerade funktioner ligger det från 7 900 kr.",
  },
  {
    q: "Hur lång tid tar det?",
    a: "En enklare företagssajt tar 2–4 veckor. Du får se en demo innan du betalar ett öre.",
  },
  {
    q: "Bygger du i WordPress eller något annat?",
    a: "Jag rekommenderar teknik efter dina behov. WordPress för e-handel och sidor du vill redigera själv. Next.js för maximal prestanda.",
  },
  {
    q: "Kan ni hjälpa företag utanför Helsingborg?",
    a: "Absolut. Jag jobbar med företag i hela Skåne och Sverige. Men det är extra smidigt för företag i Helsingborg-området.",
  },
  {
    q: "Vad händer efter lansering?",
    a: "Jag erbjuder managed hemsida-paket från 390 kr/mån där jag sköter uppdateringar, säkerhet och support.",
  },
];

export default function HelsingborgHemsidaContent() {
  ...
  return (
    <>
      <PageHero
        breadcrumbs={[
          { label: "Start", href: "/" },
          { label: "Helsingborg", href: "/helsingborg" },
          { label: "Hemsida" },
        ]}
        badge="Hemsida Helsingborg"
        title="Professionell hemsida för företag i Helsingborg."
        subtitle="Du behöver inte en stor byrå i Stockholm — du behöver en webbplats som ger resultat. Jag bygger snabba, moderna sajter åt lokala företag."
        bullets={[
          "Från 3 900 kr",
          "Klar på 2–4 veckor",
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            badge="Lokal partner"
            title="Varför företag i Helsingborg väljer mig."
            subtitle="En sajt är inte bara design — det är ditt viktigaste säljverktyg."
          />
          <Reveal delay={0.14}>
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            ...
            subtitle="Samma pris oavsett om du sitter i centrala Helsingborg eller Ramlösa."
          />
            ...
            {[
              {
                name: "Webbstart",
                price: "Från 3 900 kr",
                desc: "Professionell företagssajt med tydlig kundresa, responsiv design och SEO-grund.",
              },
              {
                name: "Webb + E-handel",
                price: "Från 7 900 kr",
                desc: "Fullskalig sajt med WooCommerce, betalningslösningar och produkthantering.",
              },
            ].map((p, i) => (
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8 bg-surface-muted">
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            badge="Serviceområde"
            title="Hemsidor för företag i västra Skåne."
            subtitle="Jag jobbar med företag i Helsingborg och övriga Skåne."
          />
          <Reveal delay={0.14}>
      ...
      <section className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-[720px] mx-auto">
          <SectionHeader
            ...
            title="Frågor om hemsidor i Helsingborg."
          />
        ...
        <div className="relative z-10 max-w-[600px] mx-auto text-center">
          ...
          <Reveal delay={0.06}>
            <p className="mt-4 text-[16px] leading-relaxed text-body">
              ...
              för ditt företag i Helsingborg.
            </p>
          </Reveal>
          <Reveal delay={0.12}>
            <a
