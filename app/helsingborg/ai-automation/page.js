    ...
    <>
      ...
      <main>
        <div style={{ padding: '60px 20px', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 'bold', marginBottom: '20px' }}>ai-automation på Helsingborg</h1>
          <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#666' }}>
            Denna tjänst är tillgänglig för Helsingborg. Kontakta oss för att läsa mer eller boka en genomgång.
          </p>
